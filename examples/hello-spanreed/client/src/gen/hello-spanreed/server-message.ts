...
import { Message, unionToMessage, unionListToMessage } from '../hello-spanreed/message';
...
static createServerMessage(builder:flatbuffers.Builder, messageType:Message, messageOffset:flatbuffers.Offset):flatbuffers.Offset {
