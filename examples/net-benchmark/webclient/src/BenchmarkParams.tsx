      ...
      >
        ...
        >
          ...
          <input
            ...
            id="tb-spanreed-url"
            pattern={"https://.*"}
            placeholder={"https://spanreed.example.com/wt"}
            style={{
              ...UrlInputStyle,
            }}
            value={spanUrl}
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            <input
              ...
              value={msgCtStr}
              onChange={(e) =>
                !loading && setMsgCtStr(e.target.value.replace(/\D/g, ""))
              }
            />
            {msgCtErr !== null && (
              <span
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            <input
              ...
              value={gapMsStr}
              onChange={(e) =>
                !loading && setGapMsStr(e.target.value.replace(/\D/g, ""))
              }
            />
            {gapMsErr !== null && (
              <span
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            <input
              ...
              onChange={(e) =>
                !loading && setPayloadSizeStr(e.target.value.replace(/\D/g, ""))
              }
            />
            {payloadSizeErr !== null && (
              <span
